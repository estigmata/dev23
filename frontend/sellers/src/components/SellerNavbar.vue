  ...
  <div class="container-main-navbar">
    ...
    <div class="ui inverted pointing menu container-navbar">
      <div class="left menu">
        ...
        <router-link class="menu-link" to="/edit-profile">
          <a class="item red"
          :class="{ active: activeButton === 'edit-profile' }"
          @click="selectNavbarButton('edit-profile')">
            Profile
          </a>
        </router-link>
        <router-link class="menu-link" to="/form-editor">
          <a class="item red"
          :class="{ active: activeButton === 'advantage-editor' }"
          @click="selectNavbarButton('advantage-editor')">
            Advantage
          </a>
        </router-link>
        <router-link class="menu-link" to="/stores">
          <a class="item red"
          :class="{ active: activeButton === 'stores' }"
          @click="selectNavbarButton('stores')">
            Stores
          </a>
        </router-link>
      </div>
